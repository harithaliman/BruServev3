...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryViewHolders>{
    ...
    public void onBindViewHolder(HistoryViewHolders holder, final int position) {
        holder.complaintId.setText(itemList.get(position).getComplaintId());
        holder.time.setText(itemList.get(position).getTime());
        holder.siteLocation.setText(itemList.get(position).getSiteLocation());
        holder.currentStatus.setText(itemList.get(position).getCurrentStatus());
